          ...
          <Box sx={{flexGrow: 1}}>
            <AppBar position="static" color="primary" sx={{height: 60}}>
              <Toolbar position="regular">
                ...
                <Typography variant="h4" color="#EE270C" component="div" sx={{flexGrow: 1, fontFamily: 'HWE', ml: 1}}>
                  Wellbeing Gallery
                </Typography>
              </Toolbar>
            </AppBar>
              ...
              <Toolbar position="regular">
                ...
                >
                  ...
                  <Menu
                    ...
                    onClose={handleClose}
                  >
                    <MenuItem sx={{fontFamily: 'HWE'}}>Hi, {user_id}</MenuItem>
                    <MenuItem sx={{fontFamily: 'HWE'}}>{email}</MenuItem>
                    <Divider />
                    <MenuItem onClick={handleLogout} sx={{fontFamily: 'HWE'}}>
                      <ListItemIcon>
